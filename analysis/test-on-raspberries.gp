...
set title "SpeedyChain RAM Consumption in IoT Environment" font ",18"
...
plot "test-on-raspberries.txt" using 1:2 with linespoints linestyle 1 title "Speedychain RAM without Stordy", \
     "test-on-raspberries.txt" using 1:3 with linespoints linestyle 2 title "Speedychain RAM with Stordy"
    #  "test-on-raspberries.txt" using 1:4 with linespoints linestyle 3 title "Speedychain Disk with Stordy"